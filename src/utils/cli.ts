...
export function mergeConfigWithCliArgs(config: Options, cliArgs: any) {
  ...
  if (Object.prototype.hasOwnProperty.call(cliArgs, 'minify')) {
    merged.minify =
      cliArgs.minify === true ? true : typeof cliArgs.minify === 'string' ? cliArgs.minify : true;
  }
  // splitting: enable code splitting / multi-file output
  if (Object.prototype.hasOwnProperty.call(cliArgs, 'splitting')) {
    merged.splitting = cliArgs.splitting === true || cliArgs.splitting === 'true';
  }
  // preserveModules: preserve source module structure
  if (Object.prototype.hasOwnProperty.call(cliArgs, 'preserveModules')) {
    merged.preserveModules = cliArgs.preserveModules === true || cliArgs.preserveModules === 'true';
  }
  // entryFileNames: custom entry chunk file name pattern
  if (cliArgs.entryFileNames) {
    merged.entryFileNames = cliArgs.entryFileNames;
  }
